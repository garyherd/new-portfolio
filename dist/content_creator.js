...
function createPortfolioModals(data) {
  data.forEach(function(item) {
    ...
    var client_link = $('<a target="_blank"></a>'); //TODO surround with strong tags
    ...
    var website_link = $('<a target="_blank">Website</a>');
    var sourceCode_link = $('<a target="_blank">Source Code</a>');
